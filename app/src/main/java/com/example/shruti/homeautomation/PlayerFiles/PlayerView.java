...
*/
    ...
    private void init(Context context) {
        ...
        mPlayer = new VideoPlayer(holder, mContext, mIn);
        mPlayer.setDisplay(getWidth(), getHeight(), PlayerView.SIZE_BEST_FIT);
        mIsPrepared = true;
    ...
    public PlayerView(Context context, AttributeSet attrs) { super(context, attrs); init(context); }
