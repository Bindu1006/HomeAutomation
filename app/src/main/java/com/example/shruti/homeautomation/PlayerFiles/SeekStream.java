 ...
 */
public abstract class SeekStream extends InputStream implements DataInput {


    public static SeekStream wrapInputStream(InputStream is,
                                                 boolean canSeekBackwards) {
        SeekStream stream = null;
        try {
